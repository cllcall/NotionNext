...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'CuiLL', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || 'CuiLL的个人博客', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://cuill.com', // 网站地址
